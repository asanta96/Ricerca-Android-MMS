...
Android\cite{WIKI,OVERVIEW,AndPortal} is a Linux-based operative
system, written in C and C++. Android application software runs on
a framework which includes Java-compatible libraries. Android uses
the Dalvik virtual machine with just-in-time compilation to run Dalvik
dex-code (Dalvik Executable), which is usually translated from Java
bytecode. Figure \ref{Android distribution diffusion} shows the actual\cite{WIKI}
distribution of Android version between devices with this kernel:

\includegraphics[scale=0.3,bb = 0 0 200 100, draft, type=eps]{C:/home/coach/Dropbox/RTOS/roba su github/Android_chart.png}
...
\includegraphics[scale=0.3,bb = 0 0 200 100, draft, type=eps]{C:/home/coach/Dropbox/RTOS/roba su github/System-architecture.jpg}
...
\includegraphics{C:/Users/Tania/Desktop/dalvik}
